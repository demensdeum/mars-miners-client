export const LOCALE = {
    'en': {
        ...
        'multiplayer_title': "Multiplayer Battle",
        'create_battle': "Create Battle",
        'join_battle': "Join Battle",
        'battle_id': "Battle ID",
        'copy_battle_id': "Copy Battle ID",
        'enter_battle_id': "Enter Battle ID",
        'waiting_for_players': "Waiting for players...",
        'players_joined': "Players: {count}/4",
        ...
        'local_game_btn': "Local Game",
        'battle_created': "Battle Created!",
        'share_id': "Share this ID with friends:",
    ...
    'ru': {
        ...
        'join_battle': "Присоединиться",
        'battle_id': "ID боя",
        'copy_battle_id': "Копировать ID",
        'enter_battle_id': "Введите ID боя",
        'waiting_for_players': "Ожидание игроков...",
        'players_joined': "Игроков: {count}/4",
        'connection_status': "Связь: {status}",
        'connected': "Подключено",
        'disconnected': "Отключено",
        'waiting_for_opponent': "Ожидание противника...",
        'server_url': "URL сервера",
        'multiplayer_btn': "Мультиплеер",
        'local_game_btn': "Локальная игра",
        'battle_created': "Бой создан!",
        'share_id': "Поделитесь ID с друзьями:",
